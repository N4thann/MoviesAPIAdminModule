...
- Filme 1:N Imagens: Um filme pode ter muitas imagens (MovieImage é um VO).
- Filme 1:N Prêmios: Um filme pode ter muitos prêmios (Award é um VO).
- Filme N:1 Diretor: Um filme possui um único diretor.
- Filme N:1 Estúdio: Um filme pertence a um único estúdio.
