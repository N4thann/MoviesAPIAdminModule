...
{
    public class ListMoviesUseCase : IQueryHandler<ListMoviesQuery, IPagedList<MovieBasicInfoResponse>>
    {
        private readonly IRepository<Movie> _repository;

        public ListMoviesUseCase(IRepository<Movie> repository) => _repository = repository;

        public async Task<IPagedList<MovieBasicInfoResponse>> Handle(ListMoviesQuery query, CancellationToken cancellationToken)
        {
