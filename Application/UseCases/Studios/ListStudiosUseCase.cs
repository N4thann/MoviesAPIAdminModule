...
{
    public class ListStudiosUseCase : IQueryHandler<ListStudiosQuery, Result<IPagedList<StudioInfoResponse>>>
    {
        ...
        public async Task<Result<IPagedList<StudioInfoResponse>>> Handle(ListStudiosQuery query, CancellationToken cancellationToken)
        {
