...
{
    public class DeactivateStudioUseCase : ICommandHandler<DeactivateStudioCommand>
    {
        private readonly IRepository<Studio> _repository;
        private readonly IUnitOfWork _unitOfWork;

        public DeactivateStudioUseCase(IRepository<Studio> repository, IUnitOfWork unitOfWork)
        {
            _repository = repository;
            _unitOfWork = unitOfWork;
        }

        public async Task Handle(DeactivateStudioCommand command, CancellationToken cancellationToken)
        {
